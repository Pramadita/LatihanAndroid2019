...
public class sign_up extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NotNull FirebaseAuth firebaseAuth) {
                ...
                if(user != null){
                    ...
                    startActivity(new Intent(sign_in.this, main_menu.class));
                    finish();
                }
            }
        };
        ...
        = (EditText) findViewById(R.id.brNamaPg);
         = (EditText) findViewById(R.id.brNoTlp);
         = (EditText) findViewById(R.id.brSandi);
         = (EditText) findViewById(R.id.vrfSandi);

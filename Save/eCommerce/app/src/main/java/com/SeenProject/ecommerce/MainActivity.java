...
import com.SeenProject.ecommerce.Model.Users;
import com.SeenProject.ecommerce.Prevalent.Prevalent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        joinNowButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentj = new Intent(MainActivity.this,RegisterActivity.class);
                startActivity(intentj);
            }
        });

        String UserPhoneKey = Paper.book().read(Prevalent.UserPhoneNumberKey);
